    ...
    <div id="tryon_screen" className="relative pb-28 min-h-screen bg-[#faf9f7] text-[#1a1c1b] font-sans max-w-md mx-auto shadow-xl">
      ...
      {activeSubTab === "canvas" && (
        <div className="flex flex-col animate-[fadeIn_0.2s_ease-out]">
          {/* Main Board row */}
          <div className="px-6 grid grid-cols-12 gap-4 mt-2">
            {/* Left Hand: Layer Manager Panel (Screenshots: "已选") */}
            <div className="col-span-4 flex flex-col space-y-2 bg-white rounded-2xl border border-gray-100 p-3 shadow-soft max-h-[360px] overflow-y-auto">
                    ...
                    .map((item) => {
                      ...
                      return (
                        <div
                          ...
                          className={`p-1.5 rounded-lg flex flex-col border transition-all cursor-pointer ${
                          ...
                          <div className="flex items-center justify-between mt-1 pt-1 border-t border-dashed border-gray-100">
                            <div className="flex space-x-1">
                              <button
                                ...
                                title="上移图层"
                                className="w-5 h-5 rounded hover:bg-gray-200 flex items-center justify-center text-gray-500 cursor-pointer"
                              >
            ...
            <div className="col-span-8 flex flex-col space-y-2">
                ...
                {canvasItems.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className={`max-w-[110px] max-h-[110px] p-2 aspect-square flex items-center justify-center rounded-xl transition-shadow ${
              ...
              {selectedItemId && (
                <div className="bg-white rounded-xl border border-gray-100 px-3.5 py-2 flex items-center justify-between space-x-3 shadow-sm">
                  <span className="text-[10px] font-bold text-gray-400 shrink-0">缩放大小:</span>
                  <input
                    type="range"
                    min={0.5}
                    max={2.0}
                    ...
                    className="flex-1 accent-black h-1 rounded bg-gray-100 appearance-none cursor-pointer"
                  />
                  <span className="font-mono text-[10px] font-semibold text-gray-700 shrink-0 w-8 text-right">
                ...
                <div className="flex space-x-3 overflow-x-auto py-1 scrollbar-thin">
                  {filteredDrawerClothing.map((cloth) => (
                    <div
                      ...
                      className="w-20 bg-[#faf9f7] rounded-xl border border-gray-100 p-1.5 flex flex-col items-center shrink-0 hover:border-black cursor-pointer group active:scale-95 transition-all"
                    >
